/*
╔══════════════════════════════════════════════════════════════════════════════════════════
║TITLE:Get_DBPermissions gdbp
╠══════════════════════════════════════════════════════════════════════════════════════════
║DESCRIPTION:
║	This script returns 3 data sets and will be used as a snippet instead of a sproc:
║		1. List of database principals
║		2. Role Membership
║		3. Object and Database level permissions
║	The final 2 columns of each query are "Un-Do"/"Do" scripts. 
║		e.g. removing a member from a role or adding them to a role. 
╠══════════════════════════════════════════════════════════════════════════════════════════
║PARAMETERS
║	@DBName
...
║DATE			║USER		║CHANGE
╠═══════════════╬═══════════╬══════════════════════════════════════════════════════════════
║2018-04-04		║mqbk		║Initial Creation
╚═══════════════╩═══════════╩══════════════════════════════════════════════════════════════
*/

DECLARE  @DBName sysname = N'NDD_ADP_RAW' 
DECLARE	 @Principal sysname = N'compass' --this is the user at the database level
DECLARE	 @Role sysname = NULL
DECLARE	 @Type nvarchar(30) = NULL
DECLARE	 @ObjectName sysname = NULL
DECLARE	 @Permission sysname = NULL
DECLARE	 @LoginName sysname = NULL
DECLARE	 @UseLikeSearch bit = 0
DECLARE	 @IncludeMSShipped bit = 0
DECLARE	 @DropTempTables bit = 1
DECLARE	 @Output varchar(30) = 'Default'
DECLARE	 @Print bit = 0
