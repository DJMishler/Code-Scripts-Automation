...
--This part of the script will give you the info, and also you can uncommment the code below to set the memory to the recommended setting.
...
--SET @spmemsetting = 'EXEC sp_configure ''max server memory'', ' + CAST(CAST(@memForSql * 1024 AS INT) AS VARCHAR(10)) + ' RECONFIGURE'
--Print @spmemsetting
--Exec(@spmemsetting)
